                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: isSelesai ? Colors.green.shade100 : Colors.lightGreen.shade100,
                            borderRadius: BorderRadius.circular(6),
                          ),
                          child: Text(
                            order['status'],
                            style: TextStyle(
                              color: isSelesai ? Colors.green.shade800 : Colors.lightGreen.shade800,
                              fontWeight: FontWeight.bold,
                              fontSize: 10,
                            ),
                          ),
              ...
              return Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      flex: 1,
                      child: Text("x${item['qty']}", textAlign: TextAlign.center, style: const TextStyle(fontSize: 14)),
                    ),
                    Expanded(
                      flex: 3,
                      child: Text(
          ...
          Row(
            ...
            children: [
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text("Tax", style: TextStyle(color: Colors.grey, fontSize: 12)),
              ...
              Column(
                ...
                children: [
                  Text(currencyFormatter.format(order['tax']), style: const TextStyle(color: Colors.grey, fontSize: 12)),
                  Text(currencyFormatter.format(order['total']), style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                ],
              ),
            ],
          ),
            ...
            children: [
              ...
              Expanded(
                child: ElevatedButton(
                  ...
                  child: Text(
                    isSelesai ? "Print Bills" : "Pay Bills",
