...
class BillPage extends StatelessWidget {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            // Text(
                            //   "+ ${item..isEmpty ? 'Dine in' : item.note}",
                            //   style: const TextStyle(
                            //     fontSize: 12,
              ...
              // --- TOTALAN ---
              _priceRow("Subtotal  Produk", total * 100 / 103),
              ...
              const Center(
                child: Text(
                  "Layanan Customer : 0812-3456-7890",
  ...
  Widget _priceRow(String label, double value) {
    return Padding(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [Text(label), Text("Rp ${value.toInt()}")],
      ),
    );
  }
}
