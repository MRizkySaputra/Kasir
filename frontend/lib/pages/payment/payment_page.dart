...
class _PaymentPageState extends State<PaymentPage> {
                ...
                itemBuilder: (ctx, i) {
                  ...
                  return Row(
                    children: [
                      ...
                      Text("Rp ${item.total.toInt()}", style: const TextStyle(fontWeight: FontWeight.bold)),
                    ],
                  );
                },
              ),
                ...
                Expanded(
                  child: _buildSectionContainer(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        _detailRow("Nama Pelanggan", widget.customerName, isHeader: true),
                        const Divider(),
                        _detailRow("Sub Total", "Rp ${widget.subtotal.toInt()}"),
                        _detailRow("Discount", "-"),
                        _detailRow("Tax 3%", "Rp ${widget.tax.toInt()}"),
                        const Divider(thickness: 1.5),
                        _detailRow("Total Payment", "Rp ${widget.total.toInt()}", isBold: true),
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            child: const Text("Pay Bills", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                          ),
                        )
                      ],
                    ),
  ...
  Widget _detailRow(String label, String value, {bool isHeader = false, bool isBold = false}) {
    return Padding(
